...
## Больше эффектов в Kineto

Понравился эффект? Попробуйте пиксельную мозаику и другие веб-эффекты в [Kineto](https://kineto.dongri.me/). Настройте и скопируйте готовый код.
