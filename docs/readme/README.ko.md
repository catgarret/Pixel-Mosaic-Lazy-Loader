...
[English](../../README.md) · **한국어** · [日本語](./README.ja.md) · [繁體中文（台灣）](./README.zh-TW.md) · [ไทย](./README.th.md) · [简体中文](./README.zh-CN.md) · [繁體中文](./README.zh-Hant.md) · [Русский](./README.ru.md) · [Italiano](./README.it.md)

[**Live Demo**](https://git.dongri.me/example/pixel-mosaic-live/) · [**Blog Post**](https://lab.dongri.me/p/pixel-mosaic-lazy-loader)

현재 버전: **v1.3.4**

여러 `<img>` 요소를 감지해 **큰 픽셀 → 작은 픽셀 → 원본 이미지** 순으로 보여주는 의존성 없는 JavaScript 이미지 로더입니다. 정적 이미지와 GIF·Animated WebP·APNG를 지원하며 애니메이션 재생을 유지합니다.
...
npm에 공개 배포하면 같은 파일이 jsDelivr에 자동으로 제공됩니다. 운영 환경에서는 버전을 고정하세요.
