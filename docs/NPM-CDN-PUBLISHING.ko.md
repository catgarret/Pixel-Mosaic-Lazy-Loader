...
```text
dong-gri-pixel-mosaic-lazy-loader-1.3.4.tgz
```
...
```text
+ @dong-gri/pixel-mosaic-lazy-loader@1.3.4
```
...
```text
https://unpkg.com/@dong-gri/pixel-mosaic-lazy-loader@1.3.4/dist/pixel-mosaic.mjs
```
...
<link
  rel="stylesheet"
  href="https://cdn.jsdelivr.net/npm/@dong-gri/pixel-mosaic-lazy-loader@1.3.4/dist/pixel-mosaic.css"
>
...
코드를 수정했더라도 다시 `1.3.4`로 덮어쓸 수 없습니다. 반드시 버전을 올려야 합니다.
...
- JS: https://cdn.jsdelivr.net/npm/@dong-gri/pixel-mosaic-lazy-loader@1.3.4/dist/pixel-mosaic.js
- CSS: https://cdn.jsdelivr.net/npm/@dong-gri/pixel-mosaic-lazy-loader@1.3.4/dist/pixel-mosaic.css
- ESM: https://cdn.jsdelivr.net/npm/@dong-gri/pixel-mosaic-lazy-loader@1.3.4/dist/pixel-mosaic.mjs

## unpkg

- JS: https://unpkg.com/@dong-gri/pixel-mosaic-lazy-loader@1.3.4/dist/pixel-mosaic.js
- CSS: https://unpkg.com/@dong-gri/pixel-mosaic-lazy-loader@1.3.4/dist/pixel-mosaic.css
- ESM: https://unpkg.com/@dong-gri/pixel-mosaic-lazy-loader@1.3.4/dist/pixel-mosaic.mjs

> 새 버전을 배포하면 위 CDN 주소의 `1.3.4`를 새 버전 번호로 바꿔야 합니다.
